...
namespace Big
{
	...
	void Config::Save()
	{
		...
		j["m_HeaderBackgroundColor"]["r"] = this->m_HeaderBackgroundColor.r;
		j["m_HeaderBackgroundColor"]["g"] = this->m_HeaderBackgroundColor.g;
		j["m_HeaderBackgroundColor"]["b"] = this->m_HeaderBackgroundColor.b;
		j["m_HeaderBackgroundColor"]["a"] = this->m_HeaderBackgroundColor.a;
		j["m_HeaderTextColor"]["r"] = this->m_HeaderTextColor.r;
		j["m_HeaderTextColor"]["g"] = this->m_HeaderTextColor.g;
		j["m_HeaderTextColor"]["b"] = this->m_HeaderTextColor.b;
		j["m_HeaderTextColor"]["a"] = this->m_HeaderTextColor.a;
		...
		j["m_HeaderGradientColorLeft"]["r"] = this->m_HeaderGradientColorLeft.r;
		j["m_HeaderGradientColorLeft"]["g"] = this->m_HeaderGradientColorLeft.g;
		j["m_HeaderGradientColorLeft"]["b"] = this->m_HeaderGradientColorLeft.b;
		j["m_HeaderGradientColorLeft"]["a"] = this->m_HeaderGradientColorLeft.a;
		j["m_HeaderGradientColorRight"]["r"] = this->m_HeaderGradientColorRight.r;
		j["m_HeaderGradientColorRight"]["g"] = this->m_HeaderGradientColorRight.g;
		j["m_HeaderGradientColorRight"]["b"] = this->m_HeaderGradientColorRight.b;
		j["m_HeaderGradientColorRight"]["a"] = this->m_HeaderGradientColorRight.a;
		...
		j["m_ScrollBarBackgroundColor"]["r"] = this->m_ScrollBarBackgroundColor.r;
		j["m_ScrollBarBackgroundColor"]["g"] = this->m_ScrollBarBackgroundColor.g;
		j["m_ScrollBarBackgroundColor"]["b"] = this->m_ScrollBarBackgroundColor.b;
		j["m_ScrollBarBackgroundColor"]["a"] = this->m_ScrollBarBackgroundColor.a;
		j["m_ScrollBarForegroundColor"]["r"] = this->m_ScrollBarForegroundColor.r;
		j["m_ScrollBarForegroundColor"]["g"] = this->m_ScrollBarForegroundColor.g;
		j["m_ScrollBarForegroundColor"]["b"] = this->m_ScrollBarForegroundColor.b;
		j["m_ScrollBarForegroundColor"]["a"] = this->m_ScrollBarForegroundColor.a;
		j["m_ScrollBarEndColor"]["r"] = this->m_ScrollBarEndColor.r;
		j["m_ScrollBarEndColor"]["g"] = this->m_ScrollBarEndColor.g;
		j["m_ScrollBarEndColor"]["b"] = this->m_ScrollBarEndColor.b;
		j["m_ScrollBarEndColor"]["a"] = this->m_ScrollBarEndColor.a;

		// Seperator
		j["m_SeperatorEnabled"] = this->m_SeperatorEnabled;
		j["m_SeperatorHeight"] = this->m_SeperatorHeight;
		j["m_SeperatorColorLeft"]["r"] = this->m_SeperatorColorLeft.r;
		j["m_SeperatorColorLeft"]["g"] = this->m_SeperatorColorLeft.g;
		j["m_SeperatorColorLeft"]["b"] = this->m_SeperatorColorLeft.b;
		j["m_SeperatorColorLeft"]["a"] = this->m_SeperatorColorLeft.a;
		j["m_SeperatorColorMiddle"]["r"] = this->m_SeperatorColorMiddle.r;
		j["m_SeperatorColorMiddle"]["g"] = this->m_SeperatorColorMiddle.g;
		j["m_SeperatorColorMiddle"]["b"] = this->m_SeperatorColorMiddle.b;
		j["m_SeperatorColorMiddle"]["a"] = this->m_SeperatorColorMiddle.a;
		j["m_SeperatorColorRight"]["r"] = this->m_SeperatorColorRight.r;
		j["m_SeperatorColorRight"]["g"] = this->m_SeperatorColorRight.g;
		j["m_SeperatorColorRight"]["b"] = this->m_SeperatorColorRight.b;
		j["m_SeperatorColorRight"]["a"] = this->m_SeperatorColorRight.a;
		...
		j["m_SubmenuBarBackgroundColor"]["r"] = this->m_SubmenuBarBackgroundColor.r;
		j["m_SubmenuBarBackgroundColor"]["g"] = this->m_SubmenuBarBackgroundColor.g;
		j["m_SubmenuBarBackgroundColor"]["b"] = this->m_SubmenuBarBackgroundColor.b;
		j["m_SubmenuBarBackgroundColor"]["a"] = this->m_SubmenuBarBackgroundColor.a;
		j["m_SubmenuBarTextColor"]["r"] = this->m_SubmenuBarTextColor.r;
		j["m_SubmenuBarTextColor"]["g"] = this->m_SubmenuBarTextColor.g;
		j["m_SubmenuBarTextColor"]["b"] = this->m_SubmenuBarTextColor.b;
		j["m_SubmenuBarTextColor"]["a"] = this->m_SubmenuBarTextColor.a;
		...
		j["m_OptionSelectedTextColor"]["r"] = this->m_OptionSelectedTextColor.r;
		j["m_OptionSelectedTextColor"]["g"] = this->m_OptionSelectedTextColor.g;
		j["m_OptionSelectedTextColor"]["b"] = this->m_OptionSelectedTextColor.b;
		j["m_OptionSelectedTextColor"]["a"] = this->m_OptionSelectedTextColor.a;
		j["m_OptionUnselectedTextColor"]["r"] = this->m_OptionUnselectedTextColor.r;
		j["m_OptionUnselectedTextColor"]["g"] = this->m_OptionUnselectedTextColor.g;
		j["m_OptionUnselectedTextColor"]["b"] = this->m_OptionUnselectedTextColor.b;
		j["m_OptionUnselectedTextColor"]["a"] = this->m_OptionUnselectedTextColor.a;
		j["m_OptionSelectedBackgroundColor"]["r"] = this->m_OptionSelectedBackgroundColor.r;
		j["m_OptionSelectedBackgroundColor"]["g"] = this->m_OptionSelectedBackgroundColor.g;
		j["m_OptionSelectedBackgroundColor"]["b"] = this->m_OptionSelectedBackgroundColor.b;
		j["m_OptionSelectedBackgroundColor"]["a"] = this->m_OptionSelectedBackgroundColor.a;
		j["m_OptionUnselectedBackgroundColor"]["r"] = this->m_OptionUnselectedBackgroundColor.r;
		j["m_OptionUnselectedBackgroundColor"]["g"] = this->m_OptionUnselectedBackgroundColor.g;
		j["m_OptionUnselectedBackgroundColor"]["b"] = this->m_OptionUnselectedBackgroundColor.b;
		j["m_OptionUnselectedBackgroundColor"]["a"] = this->m_OptionUnselectedBackgroundColor.a;

		// Footer
		j["m_FooterHeight"] = this->m_FooterHeight;
		j["m_FooterSpriteSize"] = this->m_FooterSpriteSize;
		j["m_FooterBackgroundColor"]["r"] = this->m_FooterBackgroundColor.r;
		j["m_FooterBackgroundColor"]["g"] = this->m_FooterBackgroundColor.g;
		j["m_FooterBackgroundColor"]["b"] = this->m_FooterBackgroundColor.b;
		j["m_FooterBackgroundColor"]["a"] = this->m_FooterBackgroundColor.a;
		j["m_FooterSpriteColor"]["r"] = this->m_FooterSpriteColor.r;
		j["m_FooterSpriteColor"]["g"] = this->m_FooterSpriteColor.g;
		j["m_FooterSpriteColor"]["b"] = this->m_FooterSpriteColor.b;
		j["m_FooterSpriteColor"]["a"] = this->m_FooterSpriteColor.a;
		...
		j["m_DescriptionBackgroundColor"]["r"] = this->m_DescriptionBackgroundColor.r;
		j["m_DescriptionBackgroundColor"]["g"] = this->m_DescriptionBackgroundColor.g;
		j["m_DescriptionBackgroundColor"]["b"] = this->m_DescriptionBackgroundColor.b;
		j["m_DescriptionBackgroundColor"]["a"] = this->m_DescriptionBackgroundColor.a;
		j["m_DescriptionTextColor"]["r"] = this->m_DescriptionTextColor.r;
		j["m_DescriptionTextColor"]["g"] = this->m_DescriptionTextColor.g;
		j["m_DescriptionTextColor"]["b"] = this->m_DescriptionTextColor.b;
		j["m_DescriptionTextColor"]["a"] = this->m_DescriptionTextColor.a;
		j["m_DescriptionSpriteSize"] = this->m_DescriptionSpriteSize;
		j["m_DescriptionPadding"] = this->m_DescriptionPadding;
		j["m_DescriptionSpriteColor"]["r"] = this->m_DescriptionSpriteColor.r;
		j["m_DescriptionSpriteColor"]["g"] = this->m_DescriptionSpriteColor.g;
		j["m_DescriptionSpriteColor"]["b"] = this->m_DescriptionSpriteColor.b;
		j["m_DescriptionSpriteColor"]["a"] = this->m_DescriptionSpriteColor.a;
