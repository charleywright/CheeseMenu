...
namespace Big {
	...
	void Features::ApplyCayoPericoMaxPayout() {
		...
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_CASH_I"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_CASH_C"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_WEED_I"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_WEED_C"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_COKE_I"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_COKE_C"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_GOLD_I"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_GOLD_C"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_PAINT"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_CASH_I_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_CASH_C_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_WEED_I_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_WEED_C_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_COKE_I_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_COKE_C_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_GOLD_I_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_GOLD_C_SCOPED"), -1, 1);
		STATS::STAT_SET_INT(CONSTEXPR_JOAAT("MP0_H4LOOT_PAINT_SCOPED"), -1, 1);
	}
}